...
export default function ChatInputComponent({showEmoGifBoard, isBoardVisible, message, setMe}) {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.leftView}>
        ...
        <TextInput ref={inputRef} placeholder={'Type a message'} style={styles.textInput}/>
